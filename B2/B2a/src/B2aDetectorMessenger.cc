   ...
   fDetectorConstruction(Det)
{
  ...
  fGeoCmd = new G4UIcmdWithoutParameter("/B2/det/changeGeo",this);
  fGeoCmd->SetGuidance("change the geometry.");
  fGeoCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
}
